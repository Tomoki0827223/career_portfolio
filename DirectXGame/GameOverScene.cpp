...
void GameOverScene::Initialize() {
	...
	// 既存のテクスチャをロード
	// white1x1.ddsは真っ白なテクスチャとして、sample.ddsはUIのベースとして利用
	whiteTexture_ = KamataEngine::TextureManager::Load("white1x1.dds");
	optionTexture_ = KamataEngine::TextureManager::Load("R.dds");
